...
<template>
  <div class="bg-emerald-800 h-screen flex flex-col justify-center items-center text-center text-main">
    <div :class="quoteHistory.length > 0 ? 'mt-56 mb-10 mr-20 ml-20' : 'mr-20 ml-20'">
      <QuoteCard
        :quote="quote"
        :isLoading="isLoading"
        :error="error"
    ...
    <QuoteHistory :quoteHistory="quoteHistory" />
  </div>
</template>
